...
four-digit 7-segment display in order to display the temperature of the surrounding environment. Users can quickly turn on and off the display by pushing on the push button. 

### Circuit Diagram (Schematic) 
![Schematic drawing](images/schematic.png)

### Other Images 
![Picture of circuit](images/circuit.jpg)
